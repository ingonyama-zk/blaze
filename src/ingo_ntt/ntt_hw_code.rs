...
pub enum INGO_NTT_SUPER_PROGRAM_ADDR {
    ...
    XHBM_SS_CONTROL_ADDR_DEBUG_INPUT_ENABLE_DEBUG_PROGRAM_DATA = 0x010,
    // XHBM_SS_CONTROL_BITS_DEBUG_INPUT_ENABLE_DEBUG_PROGRAM_DATA = 1,
    ...
    XHBM_SS_CONTROL_ADDR_DEBUG_INPUT_DEBUG_PROGRAM_BASE = 0x020,
    XHBM_SS_CONTROL_ADDR_DEBUG_INPUT_DEBUG_PROGRAM_HIGH = 0x03f,
    // XHBM_SS_CONTROL_WIDTH_DEBUG_INPUT_DEBUG_PROGRAM = 40,
    // XHBM_SS_CONTROL_DEPTH_DEBUG_INPUT_DEBUG_PROGRAM = 4
}
